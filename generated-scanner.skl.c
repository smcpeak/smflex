...
const char *scanner_skl_contents[] = {
  ...
  "",
  "%if option_reject",
  "/* Number of elements in 'yy_state_buf'.",
  " *",
  ...
  "{                                                              \\",
  "  YY_ASSERT(yy_lexer->yy_state_buf <= yy_lexer->yy_state_ptr); \\",
  "  YY_ASSERT(yy_lexer->yy_state_ptr <                           \\",
  "            yy_lexer->yy_state_buf + YY_STATE_BUF_ELEMENTS);   \\",
  "}",
  "%endif # option_reject",
  "",
  ...
  "    yy_lexer->yy_state_ptr = yy_lexer->yy_state_buf;             \\",
