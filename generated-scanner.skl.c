...
const char *scanner_skl_contents[] = {
  ...
  "%if do_yywrap",
  "%if yyclass",
  "/* 'yyFlexLexer::yym_wrap()' is pure, so not defined here. */",
  "%else",
  "/* There is no definition of 'yyFlexLexer::yym_wrap()' here.  Instead,",
  " * the 'smflex' user is obligated to provide that definition due to",
  " * the use of \"%option yywrap\". */",
  "%endif",
  "%else",
  ...
  "  yy_lexer->yy_wrap_function = &yy_wrap;",
  "%else",
