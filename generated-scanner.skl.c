...
const char *scanner_skl_contents[] = {
  ...
  " */",
  "",
  "%% cpp_header: This is where the C++-interface scanner includes its header.",
  "",
  "%*    Both interfaces use malloc and free for the buffer.",
  "#include <stdlib.h>          /* malloc, free, realloc, exit */",
  "%-    The C interface scanner reads and writes stdio FILEs.",
  "#include <stdio.h>           /* FILE, etc. */",
  "%+    The C++ interface scanner reads and writes iostream streams.",
  "#include <iostream>          /* istream, ostream, etc. */",
  "using std::istream;",
  "using std::ostream;",
  "using std::cin;",
  "using std::cout;",
  ...
  "",
  "%+",
  "/* Introduce an alias for the encapsulated buffer state structure so",
  " * the C and C++ code can share the name. */",
  "#define yy_buffer_state yyFlexLexer::yy_buffer_state_impl",
  "%*",
  "",
  ...
  "",
  "%+",
  "/* Declare the global 'yy_state_type' since that is what is used in",
  " * the rest of this file. */",
  "typedef yyFlexLexer::yy_state_type yy_state_type;",
  "%*",
  "",
  "%% yytext_def: yytext/yyin/yyout/yy_state_type/yylineno etc. def's & init go here",
  "",
  "%- Standard (non-C++) definition",
  ...
  "  yytext_ptr = yy_bp; \\",
  "%% yymore_yytext: code to fiddle yytext and yyleng for yymore() goes here",
  "  yy_hold_char = *yy_cp; \\",
  "  *yy_cp = '\\0'; \\",
  "%% array_yytext: code to copy yytext_ptr to yytext[] goes here, if %array",
  "  yy_c_buf_p = yy_cp;",
  "",
  ...
  " */",
  "",
  "%-       The global yywrap is only used for the C interface scanner.",
  ...
  "#  endif",
  "#endif",
  "%+       The C++ interface scanner requires a yywrap definition.",
  "#if defined(YY_SKIP_YYWRAP) || defined(YY_DERIVED_CLASS)",
  "/* Either we are not using yywrap, or we are but the user must define",
  " * it in their derived class.  Either way, we need a definition in",
  " * yyFlexLexer because it is virtual and has a vtable entry. */",
  ...
  "    YY_DO_BEFORE_ACTION;",
  "",
  "%% yylineno_update: code for yylineno update goes here",
  "",
  ...
  "    }",
  "    else {",
  "      std::streamsize ret = yyin->gcount();",
  ...
  "%+",
  "yyFlexLexer::yy_state_type yyFlexLexer::yy_get_previous_state()",
  "%*",
  "{",
  "  yy_state_type yy_current_state;",
  "  char *yy_cp;",
  ...
  "%+",
  "yyFlexLexer::yy_state_type yyFlexLexer::yy_try_NUL_trans( yy_state_type yy_current_state )",
  "%*",
  "{",
  "  int yy_is_jam;",
  ...
  "  *--yy_cp = (char) c;",
  "",
  "%% yyunput_update_yylineno: update yylineno here",
  "",
  "  yytext_ptr = yy_bp;",
  "  yy_hold_char = *yy_cp;",
  "  yy_c_buf_p = yy_cp;",
  ...
  "",
  "%% yyinput_update_BOL: update BOL and yylineno",
  "",
  "  return c;",
  "}",
  "",
  ...
  "  while (yylex() != 0)",
  "%+",
  "#ifdef YY_DERIVED_CLASS",
  "  YY_DERIVED_CLASS lexer;",
  "#else",
  "  yyFlexLexer lexer;",
  "#endif",
  "  while (lexer.yylex() != 0)",
