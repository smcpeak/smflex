...
const char *scanner_skl_contents[] = {
  ...
  "",
  "%if cpp_interface",
  "/* Make all C API functions static. */",
  "#define STATIC_IF_CPP static",
  "%else",
  ...
  "%# The C API functions only need forwards if we are emitting the C++",
  "%# API since otherwise the header already declared them.",
  "%if cpp_interface",
  ...
  "STATIC_IF_CPP int yy_read_character(yy_lexer_t *yy_lexer);",
  "%endif",
  "%if option_yy_unread_character",
  "STATIC_IF_CPP void yy_unread_character(yy_lexer_t *yy_lexer, int c);",
  "%endif",
  "%endif",
  "",
  "",
  ...
  "#define YY_GET_BOL_STATE_ADJUSTMENT() (yy_get_bol(yy_lexer))",
  "%else",
  ...
  "",
  "%if option_reject",
  "/* We need this many more elements in 'yy_state_buffer' than in the",
  " * input read buffer. */",
  "#define YY_STATE_BUF_EXTRA_ELTS 3",
  "",
  "/* Check that 'yy_state_ptr' is safe to dereference.  Note that we do",
  " * allow it to point at the one-past-the-end location, but it is not",
  " * safe to dereference there. */",
  "#define YY_CHECK_STATE_PTR_BOUNDS()                               \\",
  "{                                                                 \\",
  "  YY_ASSERT(yy_lexer->yy_state_buffer <= yy_lexer->yy_state_ptr); \\",
  "  YY_ASSERT(yy_lexer->yy_state_ptr <                              \\",
  "            yy_lexer->yy_state_buffer +                           \\",
  "              yy_lexer->yy_state_buf_alloc_elts);                 \\",
  "}",
  "%endif # option_reject",
  "",
  ...
  "%endif                                                           \\",
  "%if option_reject                                                \\",
  "    /* Set up for storing up states for YY_REJECT. */            \\",
  "    yy_lexer->yy_state_ptr = yy_lexer->yy_state_buffer;          \\",
  "    YY_CHECK_STATE_PTR_BOUNDS();                                 \\",
  "    *(yy_lexer->yy_state_ptr)++ = yy_current_state;              \\",
  "%endif",
  "",
  "",
  ...
  "",
  "%if !cpp_interface",
  "int yy_lex(yy_lexer_t * const yy_lexer YY_LEX_PARAMETERS_COMMA yy_lex_parameters)",
  "%else",
  "%if option_yyclass",
  "int option_yyclass_name::yym_lex(yy_lex_parameters)",
  "%else",
  "int yyFlexLexer::yym_lex(yy_lex_parameters)",
  "%endif",
  "%endif",
  "{",
  "%if cpp_interface",
  ...
  "%endif",
  "#     define BEGIN(s) YY_SET_START_CONDITION(s)",
  "#     define YY_START YY_GET_START_CONDITION()",
  ...
  "",
  "%if option_reject",
  "  /* Check if 'yy_state_buffer' exists and is big enough.",
  "   *",
  "   * There is a slight loss of efficiency due to checking this on every",
  "   * token rather than only when the buffer changes, but",
  "   * 'yy_state_buffer' is already a very inefficient mechanism so it is",
  "   * not worth the extra complication. */",
  "  if (yy_lexer->yy_state_buf_alloc_elts <",
  "        yy_lexer->yy_current_buffer->yy_buf_alloc_size + YY_STATE_BUF_EXTRA_ELTS) {",
  "    /* Free the old buffer.  Its old contents are not needed. */",
  "    yy_flex_free(yy_lexer->yy_state_buffer);",
  "",
  "    /* Make a new one. */",
  "    yy_lexer->yy_state_buf_alloc_elts =",
  "      yy_lexer->yy_current_buffer->yy_buf_alloc_size + YY_STATE_BUF_EXTRA_ELTS;",
  "    yy_lexer->yy_state_buffer = (yy_state_type_t*)",
  "      yy_flex_alloc(sizeof(yy_state_type_t) * yy_lexer->yy_state_buf_alloc_elts);",
  "    if (!yy_lexer->yy_state_buffer) {",
  "      YY_ERROR(yy_err_out_of_memory, \"allocating yy_state_buffer\");",
  "      return 0;",
  "    }",
  "  }",
  "%endif",
  ...
  "",
  "%elif option_reject",
  "    --(yy_lexer->yy_state_ptr);",
  "    YY_CHECK_STATE_PTR_BOUNDS();",
  "    yy_current_state = *(yy_lexer->yy_state_ptr);",
  "    yy_lexer->yy_lp = yy_accept[yy_current_state];",
  "",
  ...
  "YY_POSSIBLY_UNUSED_LABEL(find_rule) /* we branch to this label when backing up */",
  "",
  "    while (1) { /* until we find what rule we matched */",
  "      if (yy_lexer->yy_lp &&",
  "          yy_lexer->yy_lp < yy_accept[yy_current_state + 1]) {",
  "        yy_act = yy_acclist[yy_lexer->yy_lp];",
  "",
  "%if variable_trailing_context_rules",
  "        if ((yy_act & YY_TRAILING_HEAD_MASK) ||",
  "            yy_lexer->yy_looking_for_trail_begin) {",
  "          if (yy_act == yy_lexer->yy_looking_for_trail_begin) {",
  ...
  "          yy_lexer->yy_looking_for_trail_begin = yy_act & ~YY_TRAILING_MASK;",
  "          yy_lexer->yy_looking_for_trail_begin |= YY_TRAILING_HEAD_MASK;",
  "",
  "%if real_reject",
  "          /* Remember matched text in case we back up due to YY_REJECT. */",
  "          yy_lexer->yy_full_match = yy_cp;",
  "          yy_lexer->yy_full_state = yy_lexer->yy_state_ptr;",
  "          yy_lexer->yy_full_lp = yy_lexer->yy_lp;",
  "%endif # real_reject",
  "        }",
  "",
  "        else {",
  ...
  "        goto find_rule;",
  "",
  "%else # !variable_trailing_context_rules",
  ...
  "      --yy_cp;",
  "",
  "      /* We could consolidate the following lines with those at",
  ...
  "    } /* while(1) */",
  "",
  "%else # !jacobson && !fulltbl && !option_reject: compressed",
  "    yy_act = yy_accept[yy_current_state];",
  "",
  ...
  "      yy_act = yy_accept[yy_current_state];",
  "    }",
  "%endif # interactive && !option_reject",
  "",
  "%endif # compressed",
  "",
  "    YY_DO_BEFORE_ACTION;",
  ...
  "      else",
  "        std::cerr << \"--EOF (start condition \" << YY_GET_START_CONDITION() << \")\\n\";",
  "%endif",
  "    }",
  "%endif",
  "",
  ...
  "",
  "%if cpp_interface",
  "  /* yyFlexLexer constructor will set these. */",
  "  yy_lexer->yy_read_input_function   = NULL;",
  "  yy_lexer->yy_write_output_function = NULL;",
  "  yy_lexer->yy_wrap_function         = NULL;",
  "  yy_lexer->yy_error_function        = NULL;",
  "%else",
  "%if use_read",
  ...
  "%endif",
  "%if option_reject",
  "  yy_lexer->yy_state_buffer = NULL;",
  "  yy_lexer->yy_state_buf_alloc_elts = 0;",
  ...
  "%if option_reject",
  "      /* Cannot enlarge because of YY_REJECT. */",
  "      YY_ERROR(yy_err_input_buffer_cannot_expand,",
  "        \"can't enlarge buffer because scanner uses YY_REJECT\");",
  "      return EOB_ACT_END_OF_FILE;",
  "%else",
  ...
  "STATIC_IF_CPP yy_buffer_state_t *yy_scan_buffer(",
  "  yy_lexer_t *yy_lexer, char *base, int size)",
  "{",
  "  yy_buffer_state_t *b;",
  "",
  ...
  "STATIC_IF_CPP yy_buffer_state_t *yy_scan_bytes(",
  "  yy_lexer_t *yy_lexer, const char *bytes, int len)",
  "{",
  "  yy_buffer_state_t *b;",
  "  char *buf;",
  "  int n;",
  ...
  "STATIC_IF_CPP yy_buffer_state_t *yy_scan_string(",
  "  yy_lexer_t *yy_lexer, const char *yy_str)",
  "{",
  ...
  "",
  "%if option_stack",
  "STATIC_IF_CPP void yy_push_start_condition(yy_lexer_t *yy_lexer, int new_cond)",
  "{",
  ...
  "      YY_ERROR(yy_err_condition_stack_overflow, NULL /*detail*/);",
  "      return;",
  "    }",
  "    new_alloc_size =",
  ...
  "    if (!new_array) {",
  "      YY_ERROR(yy_err_out_of_memory, \"yy_push_start_condition: expanding state stack\");",
  "      return;",
  "    }",
  "",
  "    /* Copy. */",
  ...
  "",
  "%if cpp_interface",
  "void yyFlexLexer::yym_push_start_condition(int new_cond)",
  "{",
  "  yy_push_start_condition(&yym_lexer_state, new_cond);",
  "}",
  "%endif",
  "",
  "",
  "STATIC_IF_CPP void yy_pop_start_condition(yy_lexer_t *yy_lexer)",
  "{",
  "  if (yy_lexer->yy_start_stack_cur_size <= 0) {",
  "    YY_ERROR(yy_err_api_misuse, \"yy_pop_start_condition: start stack is empty\");",
  "    return;",
  "  }",
  "",
  ...
  "",
  "%if cpp_interface",
  "void yyFlexLexer::yym_pop_start_condition()",
  "{",
  "  yy_pop_start_condition(&yym_lexer_state);",
  "}",
  "%endif",
  "",
  "",
  "STATIC_IF_CPP int yy_top_start_condition(yy_lexer_t const *yy_lexer)",
  "{",
  "  if (yy_lexer->yy_start_stack_cur_size <= 0) {",
  "    YY_ERROR(yy_err_api_misuse, \"yy_top_start_condition: state stack is empty\");",
  "    return INITIAL;",
  "  }",
  "",
  ...
  "",
  "%if cpp_interface",
  "int yyFlexLexer::yym_top_start_condition() const",
  "{",
  "  return yy_top_start_condition(&yym_lexer_state);",
  "}",
  "%endif",
  "",
  "",
  "STATIC_IF_CPP int yy_condition_stack_is_empty(yy_lexer_t const *yy_lexer)",
  "{",
  "  return yy_lexer->yy_start_stack_cur_size <= 0;",
  "}",
  "",
  "%if cpp_interface",
  "bool yyFlexLexer::yym_condition_stack_is_empty() const",
  "{",
  "  return !!yy_condition_stack_is_empty(&yym_lexer_state);",
  "}",
  "%endif",
  "%endif # option_stack",
  "",
  ...
  "",
  "%if cpp_interface",
  "void yyFlexLexer::yym_less_text(int new_yy_leng)",
  "{",
  "  yy_less_text(&yym_lexer_state, new_yy_leng);",
  "}",
  "%endif",
  "",
  "",
  ...
  "",
  "%if cpp_interface",
  "void yyFlexLexer::yym_set_start_condition(int state)",
  "{",
  "  yy_set_start_condition(&yym_lexer_state, state);",
  "}",
  "%endif",
  "",
  "",
  ...
  "",
  "%if cpp_interface",
  "int yyFlexLexer::yym_get_start_condition() const",
  "{",
  "  return yy_get_start_condition(&yym_lexer_state);",
  "}",
  "%endif",
  "",
  "",
