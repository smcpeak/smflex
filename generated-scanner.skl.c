...
const char *scanner_skl_contents[] = {
  ...
  "{",
  "  return yy_lexer->yy_wrapper_object->yym_read_input(dest, size);",
  "}",
  "",
  "static int yy_write_output_delegate(yy_lexer_t *yy_lexer,",
  "                                    void const *dest, int size)",
  "{",
  "  return yy_lexer->yy_wrapper_object->yym_write_output(dest, size);",
  "}",
  "%endif # cpp_interface",
  "",
  "",
  ...
  "}",
  "",
  "void yyFlexLexer::yym_switch_streams(yy_input_stream_t *new_in, yy_output_stream_t *new_out)",
  "{",
  "  if (new_in) {",
  ...
  "",
  "  if (input_istream->eof()) {",
  "    YY_DEBUG_LOG_CALL(\"first istream::eof()\", 1);",
  "    return 0;",
  "  }",
  "",
  "  if (input_istream->fail()) {",
