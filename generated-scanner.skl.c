...
const char *scanner_skl_contents[] = {
  ...
  "}",
  "",
  "static void yy_error_delegate(yy_lexer_t *yy_lexer,",
  ...
  "      YY_ERROR(yy_err_input_buffer_overflow,",
  ...
  "",
  "",
  "void yy_error_print_and_exit(yy_lexer_t *yy_lexer,",
  "  yy_error_code_t code, char const *detail)",
  "{",
  "  if (detail) {",
  ...
  "",
  "%if cpp_interface",
  "void yyFlexLexer::yym_error(yy_error_code_t code, char const *detail)",
  "{",
  "  /* This is the same as 'yy_error_print_and_exit', except using C++",
  "   * iostreams. */",
  "",
  "  if (detail) {",
  "    std::cerr << \"smflex scanner error: \" << yy_error_string(code)",
  "              << \": \" << detail << \"\\n\";",
  "  }",
  "  else {",
  "    std::cerr << \"smflex scanner error: \" << yy_error_string(code) << '\\n';",
