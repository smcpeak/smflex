...
const char *scanner_skl_contents[] = {
  ...
  "#define YY_NEW_FILE yyrestart(yy_lexer, yy_lexer->yy_input_stream)",
  "",
  ...
  "",
  "%% yy_text_def: yy_text/yy_input_stream/yy_output_stream/yy_state_type/yy_lineno etc. def's & init go here",
  "",
  "static yy_state_type yy_get_previous_state(yy_lexer_t *yy_lexer);",
  "static yy_state_type yy_try_NUL_trans(yy_lexer_t *yy_lexer, yy_state_type current_state);",
  ...
  "  *yy_cp = '\\0'; \\",
  "%% array_yy_text: code to copy yy_text_ptr to yy_text[] goes here, if %array",
  ...
  "%if yywrap",
  "%+",
  "/* When using the C++ interface, 'yywrap' delegates to the C++ method,",
  " * which the 'smflex' user must define. */",
  ...
  "#define yywrap(yy_lexer) 1",
  "%endif",
  "",
  "",
  "#ifndef YY_NO_UNPUT",
  "static void yyunput(yy_lexer_t *yy_lexer, int c, char *buf_ptr);",
  "#endif",
  "",
  "#ifndef yy_text_ptr",
  ...
  "",
  "#ifndef YY_NO_INPUT",
  "static int yy_read_character(yy_lexer_t *yy_lexer);",
  "#endif",
  "",
  "#if YY_STACK_USED",
  "#  ifndef YY_NO_PUSH_STATE",
  "static void yy_push_state(yy_lexer_t *yy_lexer, int new_state);",
  "#  endif",
  "#  ifndef YY_NO_POP_STATE",
  "static void yy_pop_state(yy_lexer_t *yy_lexer);",
  "#  endif",
  "#  ifndef YY_NO_TOP_STATE",
  "static int yy_top_state(yy_lexer_t *yy_lexer);",
  "#  endif",
  "",
  "#else",
  ...
  "%else C++ definition",
  "#  define ECHO LexerOutput(yy_lexer->yy_text, yy_lexer->yy_leng)",
  "%*",
  "#endif",
  "",
  ...
  "%% yy_input_defn: fread()/read() definition of YY_INPUT goes here unless we're doing C++",
  "%+ C++ definition",
  "    if ( (result = yy_lexer->yy_wrapper_object->LexerInput((char*)buf, max_size)) < 0 ) \\",
  ...
  "",
  "%-",
  "int yylex(yy_lexer_t * const yy_lexer)",
  "%else",
  "%if yyclass",
  ...
  "    YY_DO_BEFORE_ACTION;",
  "",
  "%% yy_lineno_update: code for yy_lineno update goes here",
  "",
  "do_action:      /* This label is used only to access EOF actions. */",
  "",
  "%% action_debug_code: debug code goes here",
  "",
  ...
  "    (yy_state_type*)yy_flex_alloc(sizeof(yy_state_type) * (YY_BUF_SIZE+2));",
  "#else",
  ...
  "}",
  "",
  "void yyFlexLexer::switch_streams(YY_INPUT_STREAM_TYPE *new_in, YY_OUTPUT_STREAM_TYPE *new_out)",
  "{",
  "  if (new_in) {",
  ...
  "      YY_BUFFER_STATE b = yy_lexer->yy_current_buffer;",
  "",
  ...
  "      yyrestart(yy_lexer, yy_lexer->yy_input_stream);",
  "    }",
  "",
  "    else {",
  ...
  " */",
  "static yy_state_type yy_try_NUL_trans(yy_lexer_t *yy_lexer, yy_state_type yy_current_state)",
  "{",
  "  int yy_is_jam;",
  ...
  "",
  "#ifndef YY_NO_UNPUT",
  "static void yyunput(yy_lexer_t *yy_lexer, int c, char *yy_bp)",
  "{",
  ...
  "  *--yy_cp = (char)c;",
  "",
  "%% yyunput_update_yy_lineno: update yy_lineno here",
  "",
  "  yy_lexer->yy_text_ptr = yy_bp;",
  "  yy_lexer->yy_hold_char = *yy_cp;",
  "  yy_lexer->yy_c_buf_p = yy_cp;",
  ...
  "",
  "%% yy_read_character_update_BOL: update BOL and yy_lineno",
  "",
  "  return c;",
  "}",
  "",
  "",
  "void yyrestart(yy_lexer_t *yy_lexer, YY_INPUT_STREAM_TYPE *input_file)",
  "{",
  "  if (!yy_lexer->yy_current_buffer) {",
  "    yy_lexer->yy_current_buffer =",
  "      yy_create_buffer(yy_lexer, yy_lexer->yy_input_stream, YY_BUF_SIZE);",
  ...
  "{",
  "  yyrestart(&yym_lexer_state, input_file);",
  "}",
  "%*",
  "",
  "",
  ...
  "",
  "%+",
  "void yyFlexLexer::yym_switch_to_buffer(YY_BUFFER_STATE new_buffer)",
  "{",
  ...
  "",
  "",
  "void yy_load_buffer_state(yy_lexer_t *yy_lexer)",
  "{",
  "  yy_lexer->yy_n_chars = yy_lexer->yy_current_buffer->yy_n_chars;",
  ...
  "",
  "",
  "YY_BUFFER_STATE yy_create_buffer(yy_lexer_t *yy_lexer,",
  ...
  "",
  "%+",
  "YY_BUFFER_STATE yyFlexLexer::yym_create_buffer(YY_INPUT_STREAM_TYPE *file,",
  "                                               int size)",
  "{",
  ...
  "",
  "%+",
  "void yyFlexLexer::yym_delete_buffer(YY_BUFFER_STATE b)",
  "{",
  ...
  "",
  "",
  "void yy_init_buffer(yy_lexer_t *yy_lexer,",
  "                    YY_BUFFER_STATE b, YY_INPUT_STREAM_TYPE *file)",
  "{",
  ...
  "",
  "%+",
  "void yyFlexLexer::yym_init_buffer(YY_BUFFER_STATE b,",
  "                                  YY_INPUT_STREAM_TYPE *file)",
  "{",
  "  yy_init_buffer(&yym_lexer_state, b, file);",
  "}",
  "%*",
  "",
  "",
  ...
  "",
  "%+",
  "void yyFlexLexer::yym_flush_buffer(YY_BUFFER_STATE b)",
  "{",
  ...
  "YY_BUFFER_STATE yy_scan_buffer(yy_lexer_t *yy_lexer,",
  ...
  "YY_BUFFER_STATE yy_scan_bytes(yy_lexer_t *yy_lexer,",
  ...
  "",
  "%+",
  "void yyFlexLexer::LexerError(char const *msg)",
  "{",
  ...
  "",
  "",
  "/* BEGIN cannot be used in section 3.  Instead, 'yy_begin' is used. */",
  "#undef BEGIN",
  "",
