...
const char *scanner_skl_contents[] = {
  ...
  "%if cpp_interface",
  "",
  "static std::string yy_make_LexError_what(yy_error_code_t code, char const *detail) YY_NOEXCEPT",
  "{",
  "  std::ostringstream oss;",
  "  if (detail) {",
  "    oss << \"smflex scanner error: \" << yy_error_string(code)",
  "        << \": \" << detail;",
  "  }",
  "  else {",
  "    oss << \"smflex scanner error: \" << yy_error_string(code);",
  ...
  "  : std::exception(),",
  "    m_what(yy_make_LexError_what(code, detail)),",
  "    m_code(code),",
  "    m_detail(detail)",
  "{}",
  "",
