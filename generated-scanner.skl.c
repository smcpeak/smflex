...
const char *scanner_skl_contents[] = {
  ...
  "YY_POSSIBLY_UNUSED_FUNCTION",
  "static void yy_unread_character(yy_lexer_t *yy_lexer, int c);",
  "#endif",
  "",
  ...
  "#  endif",
  "%else",
  "/* \"%option stack\" was not specified, so suppress these functions. */",
  ...
  "  *--yy_cp = (char)c;",
  "",
  "%% yy_unread_character_update_yy_lineno: update yy_lineno here",
  "",
  "  yy_lexer->yy_text = yy_bp;",
  "  yy_lexer->yy_hold_char = *yy_cp;",
  "  yy_lexer->yy_c_buf_p = yy_cp;",
  ...
  "",
  "%if cpp_interface",
  "YY_BUFFER_STATE yyFlexLexer::yym_scan_buffer(char *base, size_t size)",
  "{",
  ...
  "",
  "%if cpp_interface",
  "YY_BUFFER_STATE yyFlexLexer::yym_scan_string(const char *yy_str)",
  "{",
  ...
  "",
  "%if cpp_interface",
  "YY_BUFFER_STATE yyFlexLexer::yym_scan_bytes(const char *bytes, int len)",
  "{",
  ...
  "",
  "%if cpp_interface",
  "void yyFlexLexer::yym_begin(int state)",
  "{",
  "  yy_begin(&yym_lexer_state, state);",
  "}",
  "%endif",
  "",
  "",
