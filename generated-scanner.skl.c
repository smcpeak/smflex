...
const char *scanner_skl_contents[] = {
  ...
  "",
  "%if option_reject",
  "/* Number of elements in 'yy_state_buffer'.",
  " *",
  " * TODO: This is wrong!  It assumes the input buffer is a certain size,",
  " * but that is not necessarily the case! */",
  "#define YY_STATE_BUF_ELEMENTS (YY_DEFAULT_BUF_ALLOC_SIZE+2)",
  "",
  "/* Check that 'yy_state_ptr' is safe to dereference. */",
  "#define YY_CHECK_STATE_PTR_BOUNDS()                               \\",
  "{                                                                 \\",
  "  YY_ASSERT(yy_lexer->yy_state_buffer <= yy_lexer->yy_state_ptr); \\",
  "  YY_ASSERT(yy_lexer->yy_state_ptr <                              \\",
  "            yy_lexer->yy_state_buffer + YY_STATE_BUF_ELEMENTS);   \\",
  "}",
  "%endif # option_reject",
  "",
  ...
  "",
  "%if option_reject",
  "    YY_ASSERT(yy_lexer->yy_state_buffer == NULL);",
  "    yy_lexer->yy_state_buffer =",
  "      (yy_state_type_t*)yy_flex_alloc(sizeof(yy_state_type_t) * YY_STATE_BUF_ELEMENTS);",
