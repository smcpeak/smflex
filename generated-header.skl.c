...
const char *header_skl_contents[] = {
  ...
  "   *",
  "   * Invariant: 0 <= yy_n_chars <= yy_current_buffer->yy_buf_alloc_size",
  "   * Invariant: yy_current_buffer->yy_buffer[yy_n_chars+0] == YY_END_OF_BUFFER_CHAR",
  "   * Invariant: yy_current_buffer->yy_buffer[yy_n_chars+1] == YY_END_OF_BUFFER_CHAR",
  "   */",
  "  int yy_n_chars;",
  "",
  ...
  "   * Invariant: yy_c_buf_p <= yy_current_buffer->yy_buffer + yy_n_chars + 2",
  "   *",
  "   * I'm not sure, but I think it is possible for yy_c_buf_p to reach",
  "   * the one-past-the-end location, i.e., yy_n_chars + 2. */",
  "  char *yy_c_buf_p;",
  "",
