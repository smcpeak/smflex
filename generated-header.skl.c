...
const char *header_skl_contents[] = {
  ...
  "   * and call 'yy_destroy' to clean up instead.",
  "   *",
  ...
  "  void (*yy_error_function)(struct yy_lexer_struct *yy_lexer,",
  ...
  "",
  "  /* Called when an error occurs.  The default behavior is to print a",
  "   * message to stderr and exit. */",
  "  virtual void yym_error(yy_error_code_t code, char const *detail);",
  "",
  "",
  "  /* ---------------------------------------------------------- */",
